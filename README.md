...
The purpose of this project is to demonstrate our ability to collect, work with, and clean a data set. The goal is to prepare a tidy data that can be used for later analysis. The files in this repository take the Samsung data set from the course work (see details below from the Coursera Course material Getting and Cleaning Data) and does the following: 
